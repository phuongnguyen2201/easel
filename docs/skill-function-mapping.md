...
> 当前共 **103 个 Skill**；这里只说明各 Skill 负责什么，具体输入、输出和执行流程请查看对应目录。
...
| `skill-cross-platform-publish` | Đăng một nội dung lên nhiều nền tảng trong một lượt: kiểm tra ràng buộc từng nền tảng (số chữ, tỉ lệ, hashtag, loại nội dung), định tuyến tới SKILL đăng đã có adapter, in lệnh chạy thử; nền tảng chưa có adapter thì chỉ soạn bản để đăng tay. |
